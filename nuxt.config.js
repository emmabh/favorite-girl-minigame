const PROJECT_TITLE = "Favorite Girl";
const PROJECT_SHORT_TITLE = "Fav Girl";
const PROJECT_DESCRIPTION = "What would you do to achieve your dream?";
const PROJECT_KEYWORDS = "Izzy Raye, Izzy, Raye, Favorite, girl, music, indie, artist, EP"; // add more
const PROJECT_DOMAIN = "https://favorite-girl.com";
...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: "twitter:site", content: "@izzyraye_" },
      {
        name: "twitter:title",
        content: PROJECT_TITLE
      },
